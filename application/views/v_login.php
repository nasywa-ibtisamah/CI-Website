					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								...
								<form id="register-form" action="<?php echo base_url().'home/registerData' ?>" method="post" role="form" style="display: none;">
					                  <div class="form-group">
									...
									<div class="form-group">
										<input type="number" name="nomor" id="nomor" tabindex="1" class="form-control" placeholder="No. Telepon">
									</div>
									<div class="form-group">
										<input type="textarea" name="alamat" id="alamat" tabindex="1" class="form-control" placeholder="Alamat">
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
