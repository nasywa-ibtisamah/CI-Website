    		      ...
    		      <div class="col-md-12">
                    ...
                    <div id="carousel-demo" class="carousel slide" data-ride="carousel" data-interval="2000">
                     ...
                     <div class="col-sm-6 pull-right wow fadeInRightBig">
                    		<img src="<?php echo base_url("assets/img/produk/500k.jpg")?>" alt="">
                	</div>
                      <h1 style="text-align: center;">Paket 1</h1>
                      <h2 style="color: #D3C2BC;">Sate</h2>
                      <ul style="color: white;">
                      	<li>50 tusuk Marshmallow</li>
                      	<li>30 tusuk Jelly Candy/ Donat Mini/ Brownies (Pilih satu)</li>
                      	<li>40 tusuk Rainbow Cake</li>
                      </ul>
                    ...
                    <a href="<?php echo base_url().'cpaket/paket2'?>" class="btn btn-danger active">Paket 2</a>
            </div>
            </div>
            </div>
          </div>
