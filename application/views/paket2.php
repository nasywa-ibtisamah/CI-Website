...
<!-- Top carosel section starting here  -->
    	<div class="section" style="background-color: #5A423B;" id="main-carousel">
    		      ...
    		      <div class="col-md-12">
                    ...
                    <div id="carousel-demo" class="carousel slide" data-ride="carousel" data-interval="2000">
                     <!-- Indicators -->
                      <div class="col-sm-6 pull-right wow fadeInRightBig">
                    		<img src="<?php echo base_url("assets/img/produk/750k.jpg")?>" alt="">
                	</div>
                      <h1 style="text-align: center;">Paket 2</h1>
                    ...
                    <a href="<?php echo base_url().'cpaket/paket3'?>" class="btn btn-danger active">Paket 3</a> 
            </div>
            </div>
            </div>
          </div>
