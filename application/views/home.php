									...
									<div class="container-fluid">
										...
										<div class="collapse navbar-collapse scrollspy smooth-scroll " id="nav-collapse">
											<ul class="nav navbar-nav navbar-left wow zoomIn" data-wow-delay="0.5s">
												...
												<li><a href="<?php echo base_url().'home/carapesan'?>">Cara Pesan</a></li>
    	  ...
    	  <div class="col-md-12"><h1 class="title text-center wow fadeInLeft"><span>Paket Fountain</span></h1>
                ...
                <div class="speciality wow fadeIn" data-wow-delay="0.6s">
	             ...
	             <div class="spe-prods">
					...
					<div class="price-bottom">
						...
						<div class="price2">
								<a href="<?php echo base_url().'cpaket'?>" class="buybtn">Include</a>
						</div>
					</div>
				</div>
			...
			<div class="spe-prods">
				...
				<div class="price-bottom">
					...
					<div class="price2">
						<a href="<?php echo base_url().'cpaket/paket2'?>" class="buybtn">Include</a>
					</div>
				</div>
			</div>
				<div class="spe-prods">
					...
					<div class="price1">
						...
						<div class="price2">
							<a href="<?php echo base_url().'cpaket/paket3'?>" class="buybtn">Include</a>
						</div>
					</div>
				</div>
				<div class="spe-prods">
					...
					<div class="price1">
						...
						<div class="price2">
							<a href="<?php echo base_url().'cpaket/paket4'?>" class="buybtn">Include</a>
						</div>
					</div>
				</div>
				</div>
			...
			<div class="container text-center"><h1 id="products" class="title text-center"><span>Produk Lain</span></h1>
				<div class="row">
                    <div class="carousel slide row" data-ride="carousel" data-type="multi" data-interval="2000" id="fruitscarousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item">
                                <div class="col-md-3 col-sm-4 col-xs-12"><a href="<?php echo base_url().'produklain/gleg'?>"><img src="<?php echo base_url("assets/img/gleg1.jpg")?>" class="img-responsive"></a></div>
                            </div>
                            <div class="item">
                                <div class="col-md-3 col-sm-4 col-xs-12"><a href="<?php echo base_url().'produklain/chocojar'?>"><img src="<?php echo base_url("assets/img/choco.png")?>" class="img-responsive"></a></div>
                            </div>
                            <div class="item">
                                <div class="col-md-3 col-sm-4 col-xs-12"><a href="<?php echo base_url().'produk/gleg'?>"><img src="<?php echo base_url("assets/img/gleg2.jpg")?>" class="img-responsive"></a></div>
                            </div>
                            <div class="item">
                                <div class="col-md-3 col-sm-4 col-xs-12"><a href="<?php echo base_url().'produklain/huruf'?>"><img src="<?php echo base_url("assets/img/huruf1.jpg")?>" class="img-responsive"></a></div>
                            </div>
                            <div class="item active">
                                <div class="col-md-3 col-sm-4 col-xs-12"><a href="<?php echo base_url().'produklain/chocojar'?>"><img src="<?php echo base_url("assets/img/chocojar2.jpg")?>" class="img-responsive"></a></div>
                            </div>
                            <div class="item">
                                <div class="col-md-3 col-sm-4 col-xs-12"><a href="<?php echo base_url().'produklain'?>"><img src="<?php echo base_url("assets/img/mente1.jpg")?>" class="img-responsive"></a></div>
                            </div>
                        </div>
...
<!-- Contact / Order  form -->
		...
		<div id="enquiry">
			<div class="section wow pulse" style="background-color:#D3C2BC;">
				<div class="container">
					<h1 class="title text-center ">Order Online?</h1>
                    <p class="sub-headers text-center">Register Dahulu :)</p>
					<div class="row">
...
<!-- Site footer -->
      <div class="panel-footer text-center wow fadeInUp">
        <p>&copy; <a href="<?php echo base_url().'sitefooter'?>">Tentang Kami</a> | <a href="<?php echo base_url().'sitefooter/privacy'?>">Kebijakan Privasi</a> | <a href="<?php echo base_url().'sitefooter/terms'?>">Syarat dan Ketentuan</a></p>
      </div>    
