    		      ...
    		      <div class="col-md-12">
                    ...
                    <div id="carousel-demo" class="carousel slide" data-ride="carousel" data-interval="2000">
                     ...
                     <div class="col-sm-6 pull-right wow fadeInRightBig">
                    		<img src="<?php echo base_url("assets/img/gleg.jpg")?>" alt="">
                	</div>
                      <h1 style="text-align: center;">Gleg</h1>
                      <h3 style="color: #D3C2BC;">"Sebotol Pasti Kurang"</h3>
		...
		<div id="enquiry">
			<div class="section wow pulse" style="background-color:#D3C2BC;">
				<div class="container">
                    ...
                    <p class="sub-headers text-center">Klik Cara Pesan</p>
					<div class="row">
