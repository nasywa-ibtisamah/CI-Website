                    ...
                    <div id="carousel-demo" class="carousel slide" data-ride="carousel" data-interval="2000">
                     <!-- Indicators -->
                      <div class="col-sm-6 pull-right wow fadeInRightBig">
                    		<img src="<?php echo base_url("assets/img/produk/1500k.jpg")?>" alt="">
                	</div>
                      <h1 style="text-align: center;">Paket 4</h1>
                      <h2 style="color: #D3C2BC;">Sate</h2>
                      <ul style="color: white;">
                      	<li>50 tusuk Lapis Legit</li>
                      	<li>50 tusuk Donat Mini/ Brownies</li>
                      	<li>60 tusuk Lapis Kukus Surabaya</li>
                      	<li>70 tusuk Jelly Candy</li>
                      	<li>80 tusuk buah Melon + Anggur</li>
                      	<li>90 tusuk Rainbow Cake</li>
                      	<li>100 tusuk Marshmallow</li>
                      	
                      </ul>
                  	<h2 style="color: #D3C2BC;">Termasuk</h2>
                  	<ul>
                      	<li>Operator</li>
                      	<li>Tissue</li>
                      	<li>Piring Kertas</li>
                      ...
                      <a href="<?php echo base_url().'cpaket'?>" class="btn btn-danger active">Paket 1</a>
            </div>
            </div>
            </div>
          </div>
		...
		<div id="enquiry">
			<div class="section wow pulse" style="background-color:#D3C2BC;">
				<div class="container">
                    ...
                    <p class="sub-headers text-center">Klik Login</p>
					<div class="row">
