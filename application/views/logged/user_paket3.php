    		      ...
    		      <div class="col-md-12">
                    ...
                    <div id="carousel-demo" class="carousel slide" data-ride="carousel" data-interval="2000">
                     <div class="col-sm-6 pull-right wow fadeInRightBig">
                    		<img src="<?php echo base_url("assets/img/produk/1000k.jpg")?>" alt="">
                	</div>
                     <!-- Indicators -->
                      <h1 style="text-align: center;">Paket 3</h1>
                      <h2 style="color: #D3C2BC;">Sate</h2>
                      <ul style="color: white;">
                      	<li>40 tusuk Jelly Candy</li>
                      	<li>40 tusuk Lapis Surabaya/ Lapis Legit/ Donat Mini</li>
                      	<li>60 tusuk buah melon + anggur</li>
                      	<li>90 tusuk Rainbow Cake</li>
                      	<li>90 tusuk Marshmallow</li>
                      </ul>
            		...
            		<a href="<?php echo base_url().'cpaket_logged/paket4'?>" class="btn btn-danger active">Paket 4</a>
